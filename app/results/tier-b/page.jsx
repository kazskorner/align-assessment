  ...
  return (
    <div style={{ maxWidth: '700px', margin: '50px auto', padding: '24px', fontFamily: 'Georgia, serif' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <div style={{
          display: 'inline-block', padding: '6px 20px', backgroundColor: '#4a7fa5',
          color: 'white', borderRadius: '20px', fontSize: '16px', fontWeight: 'bold',
        }}>
          Tier B — Qualified
        </div>
        <p style={{ color: '#555', marginTop: '16px', fontSize: '16px' }}>
          You're building strong financial momentum — the right strategy will take you further.
        </p>
      </div>
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 10px 0', fontSize: '20px' }}>Let's map the next step together.</h3>
        <p style={{ margin: '0 0 20px 0', opacity: 0.85, fontSize: '15px' }}>
          A 30-minute conversation can show you exactly where you stand and what to do next.
        </p>
        <a
