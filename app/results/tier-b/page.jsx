...
export default function ResultsTierB() {
    ...
    <div style={{ maxWidth: '700px', margin: '50px auto', padding: '24px', fontFamily: 'Georgia, serif' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <div style={{
          ...
          backgroundColor: '#7a9fc4', color: 'white',
          borderRadius: '20px', fontSize: '16px', fontWeight: 'bold',
        }}>
          Tier B — Strategic
        </div>
        <p style={{ color: '#555', marginTop: '16px', fontSize: '16px' }}>
          You have a solid foundation — let's optimize and close any gaps before you retire.
        </p>
      </div>
      ...
      <div style={{ backgroundColor: '#e8dcc8', padding: '24px', borderRadius: '8px', marginBottom: '32px', marginTop: '24px' }}>
        ...
        <h4 style={{ color: '#7a9fc4', fontSize: '22px', margin: '0 0 12px 0' }}>{results.persona}</h4>
      ...
      <div style={{ textAlign: 'center', padding: '32px', backgroundColor: '#1a3d5c', borderRadius: '8px', color: 'white' }}>
        <h3 style={{ margin: '0 0 10px 0', fontSize: '20px' }}>You're primed for strategic planning.</h3>
        <p style={{ margin: '0 0 20px 0', opacity: 0.85, fontSize: '15px' }}>
          Let's find the gaps in your current plan and optimize before it's too late to adjust.
        </p>
        <a
