  ...
  return (
    <div style={{ maxWidth: '700px', margin: '50px auto', padding: '24px', fontFamily: 'Georgia, serif' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <div style={{
          display: 'inline-block', padding: '6px 20px', backgroundColor: '#d4af37',
          color: 'white', borderRadius: '20px', fontSize: '16px', fontWeight: 'bold',
        }}>
          Tier A — Premier
        </div>
        <p style={{ color: '#555', marginTop: '16px', fontSize: '16px' }}>
          You're in an excellent position to build a sophisticated retirement strategy.
        </p>
      </div>
      ...
      <div style={{
        ...
        {copy?.persona && (
          <>
            <p style={{ fontSize: '15px', fontWeight: 'bold', color: '#555', margin: '0 0 8px 0' }}>
              About You
            </p>
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 10px 0', fontSize: '20px' }}>Ready to architect your retirement?</h3>
        <p style={{ margin: '0 0 20px 0', opacity: 0.85, fontSize: '15px' }}>
          Let's build a strategy that matches your ALIGN profile — together.
        </p>
        <a
